...
| `src/mcp_code_checker/utils/subprocess_runner.py` | Add `MAX_STDERR_IN_ERROR = 500` constant |
| `src/mcp_code_checker/code_checker_pytest/runners.py` | Add "No module named" detection, stderr surfacing, remove `collect_environment_info` call and `environment_info` from result dict |
