...
from src.code_checker_pylint.utils import filter_pylint_codes_by_category, normalize_path
...
class TestFilterPylintCodesByCategory:
    ...
    def test_filter_by_multiple_categories(self) -> None:
        ...
        pylint_codes: Set[str] = {"C0301", "R0201", "W0613", "E0602", "F0001"}
        categories: Set[PylintMessageType] = {PylintMessageType.ERROR, PylintMessageType.FATAL}
