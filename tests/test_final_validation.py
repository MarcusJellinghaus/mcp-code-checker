...
class TestParameterCombinationsValidation:
    ...
    def test_show_details_true_with_specific_test(self, temp_project):
        ...
        mock_test_results = PytestReport(
            ...
            root="/tmp",
            environment={},
            summary=Summary(failed=1, collected=1, total=1, passed=0, error=0, skipped=0),
            tests=[],
            collectors=[]
        )
    ...
    def test_show_details_false_with_few_tests_provides_hint(self, temp_project):
        ...
        mock_test_results = PytestReport(
            ...
            root="/tmp",
            environment={},
            summary=Summary(failed=1, collected=2, total=2, passed=1, error=0, skipped=0),
            tests=[],
            collectors=[]
        )
    ...
    def test_collection_errors_always_shown(self, temp_project):
        ...
        result_false = server._format_pytest_result_with_details(test_result, show_details=False)
        result_true = server._format_pytest_result_with_details(test_result, show_details=True)
...
class TestOutputFormatConsistency:
    ...
    def test_success_message_consistency(self):
        ...
        result_false = server._format_pytest_result_with_details(success_result, show_details=False)
        result_true = server._format_pytest_result_with_details(success_result, show_details=True)
    ...
    def test_error_message_consistency(self):
        ...
        result_false = server._format_pytest_result_with_details(error_result, show_details=False)
        result_true = server._format_pytest_result_with_details(error_result, show_details=True)
    ...
    def test_invalid_summary_handling(self):
        ...
        result_false = server._format_pytest_result_with_details(invalid_result, show_details=False)
        result_true = server._format_pytest_result_with_details(invalid_result, show_details=True)
...
class TestPerformanceBenchmarks:
    ...
    def test_performance_impact_measurement(self):
        ...
        assert overhead_ratio < 0.5, f"Performance overhead too high: {overhead_ratio:.2%}"
    ...
    def test_memory_usage_reasonable(self):
        ...
        result = server._format_pytest_result_with_details(large_summary, show_details=True)
...
class TestDocumentationAccuracy:
    ...
    def test_docstring_examples_execute(self):
        ...
        try:
            ...
            result = server._format_pytest_result_with_details(
                {"success": True, "summary": {"failed": 0, "passed": 5, "collected": 5}}, 
                show_details=False
            )
            assert isinstance(result, str)
            ...
            result = server._format_pytest_result_with_details(
                {"success": True, "summary": {"failed": 1, "passed": 0, "collected": 1}}, 
                show_details=True
            )
            assert isinstance(result, str)
    ...
    def test_return_type_consistency(self):
        ...
        for test_case in test_cases:
            for show_details in [True, False]:
                result = server._format_pytest_result_with_details(test_case, show_details)
...
class TestEdgeCases:
    ...
    def test_none_values_handling(self):
        ...
        result = server._format_pytest_result_with_details(result_with_nones, show_details=True)
        assert isinstance(result, str)
        
        # Should not crash with None values
        result = server._format_pytest_result_with_details(result_with_nones, show_details=False)
        assert isinstance(result, str)
    ...
    def test_empty_summary_handling(self):
        ...
        result = server._format_pytest_result_with_details(empty_result, show_details=True)
        assert isinstance(result, str)
    ...
    def test_missing_summary_handling(self):
        ...
        result = server._format_pytest_result_with_details(no_summary_result, show_details=True)
        assert isinstance(result, str)
