...
def test_mypy_in_all_checks() -> None:
    ...
    result = get_mypy_prompt(
        project_dir=".",
        strict=True,
        target_directories=["src/code_checker_mypy"]
    )
...
""")
        ...
        result = run_mypy_check(project_dir=tmpdir, strict=True, target_directories=["."])
...
""")
        ...
        result1 = run_mypy_check(project_dir=tmpdir, strict=True, target_directories=["."])
